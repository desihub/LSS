...
python mkCat_singletile.py --type ELG --tile 80623 --night deep --fadate 20201218 #this creates clustering catalogs for ELGs (LRG, QSO, BGS_ANY all work) on tile 80623 (see https://desi.lbl.gov/trac/wiki/SurveyValidation/SV1#ObservedTiles for the initial list) using the deep coadd from the blanc release redshift data; fadate is required to tell the code where to look for data related to the fiberassign files 
