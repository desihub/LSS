...
if make_tiles:
    ...
    n = mb.prepare_tile_batches(surveysim_file, output_path=foot, program='dark', start_day=365, end_day=729, batch_cadence=batch_cadence) 
    n = mb.prepare_tile_batches(surveysim_file, output_path=foot, program='bright', start_day=365, end_day=729, batch_cadence=batch_cadence) 
