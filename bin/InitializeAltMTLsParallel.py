...
parser.add_argument('-ssp', '--shuffleSubpriorities', action='store_false', dest='shuffleSubpriorities', default=True, help = 'WARNING: THIS FLAG SHOULD ONLY BE USED FOR DEBUGGING. Pass this flag to NOT shuffle subpriorities. This option must be used in conjunction with --reproducing.', required = False)
