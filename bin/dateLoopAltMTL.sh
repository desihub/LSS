...
do
    ...
    srun --cpu-bind=none --nodes=$NNodes -C haswell -A desi --qos=interactive -t 02:00:00 $path2LSS/runAltMTLParallel.py $NNodes $qR $altmtlbasedir $secondary $obscon $survey $numobs_from_ledger $redoFA $getosubp
