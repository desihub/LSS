    ...
    if combr:
        ...
        if type == 'dark' or type == 'bright':
            if specrel == 'everest':
                ...
                specf = specf[wt]
                kc = ['ZWARN','LOCATION','FIBER','COADD_FIBERSTATUS','TILEID','FIBERASSIGN_X','FIBERASSIGN_Y','COADD_NUMEXP','COADD_EXPTIME','COADD_NUMNIGHT'\
            ...
            ct.combran_wdup(mtld,ii,randir,type,ldirspec,specf,keepcol=kc)
