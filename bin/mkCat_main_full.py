...
if mkfulld:
    ...
    azf = '/global/homes/r/raichoor/main/main-elg-daily-thru20210521.fits' #file generated by Anand with OII flux info
    dz = indirspec+'datcomb_'+progl+'_tarspecwdup_zdone.fits' #new
    if type == 'BGS_BRIGHT':
