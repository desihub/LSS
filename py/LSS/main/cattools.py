...
def randomtiles_allmain_pix_2step(tiles,dirout='/global/cfs/cdirs/desi/survey/catalogs/main/LSS/random',ii=0,randir11 = '/global/cfs/cdirs/desi/target/catalogs/dr11/5.4.0/randoms/resolve/',dirrt='/global/cfs/cdirs/desi/target/catalogs/dr9/2.4.0/randoms/resolve/',logger=None ):
    '''
    tiles should be a table containing the relevant info
    '''
    from desitarget.io import read_targets_in_tiles
