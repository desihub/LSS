...
def mkclusran(ffr,fcr,fcd,maxp,loc_fail,locsna,maskbits=[],rcols=['Z','WEIGHT','SV1_DESI_TARGET','FLUX_G','FLUX_R','FLUX_Z','FLUX_W1','MW_TRANSMISSION_G','MW_TRANSMISSION_R','MW_TRANSMISSION_Z','MW_TRANSMISSION_W1','FIBERFLUX_G','FIBERFLUX_R','FIBERFLUX_Z','MASKBITS','PHOTSYS','SV1_BGS_TARGET']):
    dr = fitsio.read(ffr)
