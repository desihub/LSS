...
python $LSSCODE/LSS/scripts/main/mkCat_main.py --type BGS_BRIGHT-21.5 --verspec iron --basedir /global/cfs/cdirs/desi/survey/catalogs/  --fulld n  --survey Y1 --version $1
