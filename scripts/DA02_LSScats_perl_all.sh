...
srun -N 1 -C cpu -t 01:00:00 -q interactive python main/mkCat_main_ran.py  --type ELG_LOP  --basedir /global/cfs/cdirs/desi/survey/catalogs/ --verspec guadalupe --fullr y --notqso y --version $1
srun -N 1 -C cpu -t 01:00:00 -q interactive python main/mkCat_main_ran.py  --type QSO  --basedir /global/cfs/cdirs/desi/survey/catalogs/ --verspec guadalupe --fullr y --version $1
srun -N 1 -C cpu -t 01:00:00 -q interactive python main/mkCat_main_ran.py  --type BGS_BRIGHT  --basedir /global/cfs/cdirs/desi/survey/catalogs/ --verspec guadalupe --fullr y --version $1
