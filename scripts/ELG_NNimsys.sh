...
srun -N 1 -C cpu -t 04:00:00 --qos interactive --account desi python $scriptdir/addsys2clus.py --type ELG_LOPnotqso   --basedir /global/cfs/cdirs/desi/survey/catalogs/    --prep4sysnet y --survey $survey --verspec $verspec --imsys_zbin split  --version $version --extra_clus_dir $edir --compwtmd fraczNN
