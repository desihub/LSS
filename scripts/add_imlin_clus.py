...
if args.imsys_clus:
    ...
    for reg in regl:
        ...
        def _add_sysweight(zm,zx):
            ...
            wsysl = densvar.get_imweight(dat,rands,zm,zx,reg,fitmapsbin,use_maps,sys_tab=sys_tab,zcol='Z',modoutname = dirout+args.extra_clus_dir+tracer_clus+'_'+reg+'_'+str(zm)+str(zx)+syscol+'_linfitparam.txt',figname=dirout+args.extra_clus_dir+tracer_clus+'_'+reg+'_'+str(zm)+str(zx)+syscol+'_linclusimsysfit.png',wtmd='clus',logger=logger)
            sel = wsysl != 1
