...
srun -N 1 -C cpu -t 04:00:00 --qos interactive --account desi python $LSSCODE/LSS/scripts/main/mkCat_main.py --type BGS_BRIGHT-21.35 --fulld n --survey DA2 --verspec kibo-v1 --clusd y --clusran y --splitGC y --nz y --par y  --basedir /global/cfs/cdirs/desi/survey/catalogs/ --version v1 --imsys_colname WEIGHT_IMLIN 
--extra_clus_dir 'nonKP/'
