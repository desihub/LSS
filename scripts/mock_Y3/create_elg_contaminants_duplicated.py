...
for i in range(len(weight)):
    if int_weight[i] > 1:
        ...
        unclassified_z = np.concatenate((unclassified_z, np.atleast_1d(unclassified['Z_not4clus'][i])))
        ...
        unclassified_z = np.concatenate((unclassified_z, [unclassified['Z_not4clus'][i]]))
