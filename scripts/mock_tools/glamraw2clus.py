...
parser.add_argument("--base_dir", help="base directory for input/output",
                    default='/global/cfs/cdirs/desi/mocks/cai/GLAM-Uchuu/lightcones/prep_altmtl/')
...
parser.add_argument("--tracer_ver", default='')
...
if args.outloc == None:
    outdir = os.getenv(scratch)+'/glam'+args.tracer_ver+'/mock'+str(args.realization)+'/'
else:
    outdir = args.outloc
