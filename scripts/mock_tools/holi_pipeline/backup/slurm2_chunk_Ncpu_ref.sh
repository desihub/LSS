...
cd $LSS_DIR/scripts/mock_tools/pipe_holi
...
srun -n 1 -c $ALL_CPU ./step8_chunk.sh $LSS_DIR $DS_DIR $ID_FIRST $SZ_CHUNK $NCPU_PT > $DS_DIR/fa_chunk_${ID_FIRST}.log  2>&1
