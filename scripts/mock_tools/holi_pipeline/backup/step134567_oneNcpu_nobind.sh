...
# Avoid inheriting strict CPU binding masks from parent job steps.
...
time srun --overlap --cpu-bind=none -n 1 -c $NCPU_M2 python ./prepare_mocks_Y3_test1.py --limit_for_test 3000 --survey DA2 --specdata loa-v1 --mockname holi --input_mockpath $input_mockpath --input_mockfile $input_mockfile --tracer ELG --zrsdcol Z --output_fullpathfn $out1_ELG --save_mock_nz n --nzfilename $nzname --need_nz_calib y  &
...
time srun --overlap --cpu-bind=none -n 1 -c 1 time python ./prepare_mocks_Y3_test1.py --limit_for_test 3000 --survey DA2 --specdata loa-v1 --mockname holi --input_mockpath $input_mockpath --input_mockfile $input_mockfile --tracer LRG --zrsdcol Z --output_fullpathfn $out1_LRG --save_mock_nz n --nzfilename $nzname --need_nz_calib y &
...
time srun --overlap --cpu-bind=none -n 1 -c 1 python ./prepare_mocks_Y3_test1.py --limit_for_test 6000 --survey DA2 --specdata loa-v1 --mockname holi --input_mockpath $input_mockpath --input_mockfile $input_mockfile --tracer QSO --zrsdcol Z --output_fullpathfn $out1_QSO --save_mock_nz n --nzfilename $nzname --need_nz_calib y &
...
time srun --overlap --cpu-bind=none -n $NCPU -c 1 $EXE_PATH/BRICKMASK -i $DS_DIR/input$IDS.txt -o $DS_DIR/output$IDS.txt -c $PROC_DIR/brickmask.conf
...
time srun --overlap --cpu-bind=none -n 1 -c $NCPU_M2 ./join_imaging_mask_stdpars.py --inputs $out3_ELG --outputs $out4_ELG &
time srun --overlap --cpu-bind=none -n 1 -c 1 ./join_imaging_mask_stdpars.py --inputs $out3_LRG --outputs $out4_LRG &
time srun --overlap --cpu-bind=none -n 1 -c 1 ./join_imaging_mask_stdpars.py --inputs $out3_QSO --outputs $out4_QSO &
wait
...
time srun --overlap --cpu-bind=none -n 1 -c $NCPU_M2 ./add_contaminants_to_mock_stdpars.py --inputs $out4_ELG --outputs $out5_ELG &
time srun --overlap --cpu-bind=none -n 1 -c 2 ./add_contaminants_to_mock_stdpars.py --inputs $out4_QSO --outputs $out5_QSO &
wait
...
time srun --overlap --cpu-bind=none -n 1 -c $NCPU ./concatenate_tracers_to_fba_stdpars.py --inputs $in6_ELG $in6_LRG $in6_QSO --outputs $out6 --id_seed $IDS
...
time srun --overlap --cpu-bind=none -n 1 -c $NCPU ./initialize_amtl_mocks_da2_stdpars.py --inputs $out6 --outputs $out7 --obscon DARK
