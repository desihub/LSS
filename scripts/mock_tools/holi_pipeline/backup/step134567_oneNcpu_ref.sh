...
time srun -n 1 -c $NCPU_M2 --exclusive python ./prepare_mocks_Y3_test1.py --limit_for_test 3000 --survey DA2 --specdata loa-v1 --mockname holi --input_mockpath $input_mockpath --input_mockfile $input_mockfile --tracer ELG --zrsdcol Z --output_fullpathfn $out1_ELG --save_mock_nz n --nzfilename $nzname --need_nz_calib y  &
...
time srun -n 1 -c 1 --exclusive time python ./prepare_mocks_Y3_test1.py --limit_for_test 3000 --survey DA2 --specdata loa-v1 --mockname holi --input_mockpath $input_mockpath --input_mockfile $input_mockfile --tracer LRG --zrsdcol Z --output_fullpathfn $out1_LRG --save_mock_nz n --nzfilename $nzname --need_nz_calib y &
...
time srun -n 1 -c 1 --exclusive python ./prepare_mocks_Y3_test1.py --limit_for_test 6000 --survey DA2 --specdata loa-v1 --mockname holi --input_mockpath $input_mockpath --input_mockfile $input_mockfile --tracer QSO --zrsdcol Z --output_fullpathfn $out1_QSO --save_mock_nz n --nzfilename $nzname --need_nz_calib y &
