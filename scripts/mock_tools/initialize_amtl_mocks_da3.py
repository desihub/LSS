...
par=True
if desitarget.__version__ > "3.0.0":
    numproc=12
    print('desitarget is greater than 3.0.0 using nproc=12')
else:
    numproc=32
    print('desitarget is 3.0.0 using nproc=32')


recreate_tileTrack = False
aux_datapath = {'DARK': '/global/cfs/cdirs/desi/users/acarnero/altmtlTracker/DA3/mainsurvey-DARKobscon-TileTracker.ecsv', 'BRIGHT': '/global/cfs/cdirs/desi/users/acarnero/altmtlTracker/DA3/mainsurvey-BRIGHTobscon-TileTracker.ecsv'}
...
#    pass
    ...
    if par:
        mtl.make_ledger(arg1, initledger_path, obscon=obscon.upper(), numproc=numproc)
...
#yaml_path = amtl.initializeYAML_HPTracker(obscon, altmtl_path)
...
endDate='20260605' #2024-04-18T00:00:00+00:00'
##endDate='20260415' #2024-04-18T00:00:00+00:00'
