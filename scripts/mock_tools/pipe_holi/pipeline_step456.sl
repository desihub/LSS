...
PROC_DIR=/global/cfs/cdirs/desi/users/colley/fa_snake/scripts
...
srun -n 1 -c 1 $PROC_DIR/join_imaging_mask_snake.py --inputs $DS_DIR/$seed/ELG/$in_4 --outputs $DS_DIR/$seed/ELG/$in_5 &
srun -n 1 -c 1 $PROC_DIR/join_imaging_mask_snake.py --inputs $DS_DIR/$seed/LRG/$in_4 --outputs $DS_DIR/$seed/LRG/$in_5 &
srun -n 1 -c 1 $PROC_DIR/join_imaging_mask_snake.py --inputs $DS_DIR/$seed/QSO/$in_4 --outputs $DS_DIR/$seed/QSO/$in_5 &
wait

# step 5 contaminant
echo "step 5"
date
srun -n 1 -c 1 $PROC_DIR/add_contaminants_to_mock_snake.py --inputs $DS_DIR/$seed/ELG/$in_5 --outputs $DS_DIR/$seed/ELG/$in_6 &
srun -n 1 -c 1 $PROC_DIR/add_contaminants_to_mock_snake.py --inputs $DS_DIR/$seed/QSO/$in_5 --outputs $DS_DIR/$seed/QSO/$in_6 &
wait
...
srun -n 1 -c 1 $PROC_DIR/concatenate_tracers_to_fba_snake.py --inputs $in_ELG $in_LRG $in_QSO --outputs $DS_DIR/$out_6
date
