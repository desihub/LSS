...
do
 ...
 mv $SCRATCH/AbacusSummitBGS/mock$i/*GC* /global/cfs/cdirs/desi/survey/catalogs/Y1/mocks/SecondGenMocks/AbacusSummitBGS_v2/mock$i/
 mv $SCRATCH/AbacusSummitBGS/mock$i/*nz* /global/cfs/cdirs/desi/survey/catalogs/Y1/mocks/SecondGenMocks/AbacusSummitBGS_v2/mock$i/
