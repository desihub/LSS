...
python mkCat_SecondGen_amtl.py --base_output /global/cfs/cdirs/desi/survey/catalogs/DA2/mocks/SecondGenMocks/AbacusSummit_v4_1/altmtl{MOCKNUM} --mockver ab_secondgen --mocknum $1 --survey DA2 --specdata jura-v1 --add_gtl n --tracer ELG_LOP --notqso y --minr 0 --maxr 18 --outmd 'noscratch' --par y --fulld n --fullr y --apply_veto y --apply_veto_ran y --add_tl y --use_map_veto _HPmapcut --mkclusran y --mkclusdat y --splitGC y --nz y --targDir /dvs_ro/cfs/cdirs/desi/survey/catalogs/DA2/mocks/SecondGenMocks/AbacusSummit_v4_1
