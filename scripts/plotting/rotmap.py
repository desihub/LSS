...
for lonv in lon_viewing_angles:
	...
	#m.plot(x,y,'k,')
	plt.scatter(xno,yno,c=datno[sys.argv[2]],edgecolor='none',s=.1,vmax=vx,vmin=vm,zorder=1)
	plt.scatter(xo,yo,c=dato[sys.argv[2]],edgecolor='none',s=.1,vmax=vx,vmin=vm,zorder=1000)
