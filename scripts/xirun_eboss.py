...
def compute_correlation_function(corr_type, edges, zlim,nthreads=8, gpu=False, dtype='f8', wang=None, split_randoms_above=30., weight_type='default', tracer='ELG', tracer2=None, recon_dir=None, rec='_rec', njack=120, option=None, mpicomm=None, mpiroot=None, cat_read=None, dat_cat=None, ran_cat=None, rpcut=None, **kwargs):
...
if __name__ == '__main__':
    ...
    for region in regions:
        ...
        result = compute_correlation_function(corr_type, edges=edges, zlim=(zmin,zmax),nthreads=nthreads, gpu=gpu, region=region, zlim=(zmin, zmax), njack=args.njack, mpicomm=mpicomm, mpiroot=mpiroot)
                # Save pair counts
        if mpicomm is None or mpicomm.rank == mpiroot:
